...
export function BeneficiosPublico() {
  ...
  async function handleResgate() {
    ...
    // Auto-cria transação vinculada ao cupom
    const parceiroId = selected!.id;
      ...
      return (
        <>
          ...
          <div style={{
            ...
            O agendamento depende da disponibilidade do fornecedor. Após a confirmação do pagamento, a Soul coloca você em contato para marcar.
          </div>
        </>
      );
    }
  ...
  return (
    <div style={{ minHeight: '100vh', background: BG, fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", system-ui, sans-serif', color: TEXT }}>
      ...
      <a
        href={`https://wa.me/5541984079334?text=${encodeURIComponent('Olá! Preciso de ajuda com o Soul Indica.')}`}
        target="_blank"
        rel="noopener noreferrer"
        title="Falar com a Soul"
        style={{
